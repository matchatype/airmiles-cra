...
const regionsBuilder = build<{regions: string[]}>('Regions', {
  fields: {
    regions: faker.random.arrayElements(canadianProvinceList),
  },
})
...
const offerBuilder = build<Offer>('Offer', {
  fields: {
    ...
    regions: regionsBuilder().regions,
